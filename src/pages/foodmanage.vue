    ...
    <q-page>
        <template>
            <div>
                ...
                <template v-slot:after>
                    ...
                    <div>
                        <q-table grid :data="filtercateg" :columns="tab !='addInc' ? columns : incColumns"  :pagination.sync="pagination" :filter="filter" class="q-px-sm full-width align-center " row-key=".key">
        ...
        <q-dialog v-model="addFoodDialog" persistent>
            <q-card style="min-width: 400px" >
                ...
                <div class="container row q-ma-md">
                <q-input color="deep-orange-4" outlined class="q-mr-md col" dense v-model="selectedFood.foodName" label="Food Name"/>
                <q-input color="deep-orange-4" outlined class="col-3" type="number" dense v-model="selectedFood.foodPrice" label="Package Price"/>
                </div>
                <q-select color="deep-orange-4" class="q-ma-md" dense outlined v-model="selectedFood.category" :options="categoryOpt" emit-value map-options label="Dish Type" />
                ...
                <q-btn flat label="Add Food" @click="addFood" color="deep-orange-4" v-close-popup v-show="editMode != true"/>
    ...
    methods:{
        ...
        addCateg () {
            ...
            openEditDialog(food){
                ...
                console.log(this.pictureToEdit,'pictureToEdit')
                console.log(this.picFood,'picFood')
            },
            updateFood(){
            let vm = this
                let optionss = this.$lodash.filter(this.Food, m => {
