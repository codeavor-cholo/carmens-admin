            ...
            <div>
                ...
                <template v-slot:after>
                    ...
                    <div class="q-px-md text-grey-8 full-width">
                        <div class="q-my-md">
                                <q-btn fab icon="mdi-plus-thick" color="pink-3" v-show="tab != 'addInc' && tab != 'WOPP'" @click="addFoodDialog = true">
                                    <q-tooltip>
                                        Add Food
                                    </q-tooltip>
                                </q-btn>
                ...
                <div v-show="showlabel == true && partyTrayShow == true">
                    <q-card class="my-card q-pa-sm q-ma-md">
                        ...
                        <div class="row q-mx-md q-mt-md">
                            <q-input color="pink-3" class="q-mr-md col" outlined="" type="number" style=" border-color: pink" dense v-model="minpax" label="Min Pax"/>
                            <q-input color="pink-3" class="col" outlined="" type="number" style=" border-color: pink" dense v-model="maxpax" label="Max Pax"/>
                        </div>
                        <q-card-actions align="right" class="text-primary">
                        <q-btn flat color="grey-8" @click="clear" label="Cancel"/>
                        <q-btn flat color="teal" label-color="pink-3" label="Save Package" @click="addPTrayLabel" v-close-popup />
                        </q-card-actions>
                    </q-card>    
                </div>
                        ...
                        <div>
                            ...
                            <q-list dense class="text-left text-grey-8 bg-white" v-for="(i, index) in selection" :key="index">
                                <q-item dense>
                                    ...
                                    <q-item-section side>
                                        <q-input color="pink-3" outlined="" class="q-ma-sm q-pr-xl" type="number" dense v-model="partyTrayPricing[index]" label="Party Tray Price"/>
                                    </q-item-section>
                                </q-item>
                            </q-list>
                        </div>
