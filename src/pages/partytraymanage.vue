    ...
    <q-page>
        <template>
            <div>
                ...
                <q-tabs v-model="tab" vertical class="text-grey-8 bg-white full-height relative-position" :active-color="tab != 'WOPP' ? 'orange-3' : 'teal'" :active-bg-color="tab != 'WOPP' ? 'orange-1' : 'teal-1'">
                    ...
                    <div class="text-h6 text-center q-py-md" style="font-family: 'Roboto Slab', serif;">PARTY TRAYS
                        <q-btn-dropdown active-color="orange-3" active-bg-color="orange-1" flat dense dropdown-icon="more_vert" color="grey-8">
                ...
                <q-tab style="font-family: 'Roboto Slab', serif;" name="ALL" value="ALL" label="ALL"></q-tab>
        ...
        <q-dialog v-model="addFoodDialog" persistent>
            <q-card style="min-width: 400px" >
                ...
                <q-input color="orange-3" outlined class="col-12" dense v-model="foodNames" label="Party Tray Name"/>
                <q-select color="orange-3" class="col-12 q-mt-md" dense outlined v-model="selectCategory" :options="categoryOpt" emit-value map-options label="Dish Type" />
                <q-uploader ref="foodref" class="full-width q-ma-md" extensions="'.gif,.GIF,.jpg,.JPG,.jpeg,.JPEG,.png,.PNG'" @added="photoAdded" :url="foodpic" label="Upload Photo" color="orange-3" square flat bordered style="border-color: #FFDAB9" />
                </div>
                ...
                <div v-show="showlabel == true">
                    <q-card class="my-card q-pa-sm q-ma-md">
                        ...
                        <div class="row q-mx-md q-mt-md">
                            <q-input color="orange-3" class="q-mr-md col" outlined="" type="number" style=" border-color: pink" dense v-model="minpax" label="Min Pax"/>
                ...
                <div class="my-card q-ma-md q-pa-sm q-py-md text-overline row" style="border: 1.5px solid;border-color: #FFDAB9;">
                    ...
                    <q-input color="orange-3" outlined class="col q-mr-md" type="number" dense v-model="foodPrice" label="Package Price" v-show="partyTrayShow == true"/>
                </div>
                </q-card-section> 
        ...
        <q-dialog v-model="addCategory" persistent>
            <q-card style="min-width: 400px">
                ...
                <q-card-actions align="right" class="text-primary">
                    ...
                    <q-btn v-if="!isEdit" flat label="Add Category" color="pink-6" v-close-popup v-on:click="addCateg"/>
                    <q-btn v-if="isEdit" flat label="Update Category" color="pink-6" v-close-popup v-on:click="setTask"/>
                </q-card-actions>
            </q-card>
        </q-dialog>
